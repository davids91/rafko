...
class Neuron :
 ...
 public:
  ...
  enum : int {
    kInputWeightsFieldNumber = 4,
    kInputIndicesFieldNumber = 5,
    kBiasIdxFieldNumber = 1,
    kMemoryRatioIdxFieldNumber = 2,
    kTransferFunctionIdxFieldNumber = 3,
  };
  // repeated .sparse_net_library.Synapse_interval input_weights = 4;
  int input_weights_size() const;
  void clear_input_weights();
  ::sparse_net_library::Synapse_interval* mutable_input_weights(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval >*
      mutable_input_weights();
  const ::sparse_net_library::Synapse_interval& input_weights(int index) const;
  ::sparse_net_library::Synapse_interval* add_input_weights();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval >&
      input_weights() const;

  // repeated .sparse_net_library.Synapse_interval input_indices = 5;
  int input_indices_size() const;
  void clear_input_indices();
  ::sparse_net_library::Synapse_interval* mutable_input_indices(int index);
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval >*
      mutable_input_indices();
  const ::sparse_net_library::Synapse_interval& input_indices(int index) const;
  ::sparse_net_library::Synapse_interval* add_input_indices();
  const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval >&
      input_indices() const;
 ...
 private:
  ...
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval > input_weights_;
  ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval > input_indices_;
...
// repeated .sparse_net_library.Synapse_interval input_weights = 4;
inline int Neuron::input_weights_size() const {
  return input_weights_.size();
}
inline ::sparse_net_library::Synapse_interval* Neuron::mutable_input_weights(int index) {
  // @@protoc_insertion_point(field_mutable:sparse_net_library.Neuron.input_weights)
  return input_weights_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval >*
Neuron::mutable_input_weights() {
  // @@protoc_insertion_point(field_mutable_list:sparse_net_library.Neuron.input_weights)
  return &input_weights_;
}
inline const ::sparse_net_library::Synapse_interval& Neuron::input_weights(int index) const {
  // @@protoc_insertion_point(field_get:sparse_net_library.Neuron.input_weights)
  return input_weights_.Get(index);
}
inline ::sparse_net_library::Synapse_interval* Neuron::add_input_weights() {
  // @@protoc_insertion_point(field_add:sparse_net_library.Neuron.input_weights)
  return input_weights_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval >&
Neuron::input_weights() const {
  // @@protoc_insertion_point(field_list:sparse_net_library.Neuron.input_weights)
  return input_weights_;
}

// repeated .sparse_net_library.Synapse_interval input_indices = 5;
inline int Neuron::input_indices_size() const {
  return input_indices_.size();
}
inline ::sparse_net_library::Synapse_interval* Neuron::mutable_input_indices(int index) {
  // @@protoc_insertion_point(field_mutable:sparse_net_library.Neuron.input_indices)
  return input_indices_.Mutable(index);
}
inline ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval >*
Neuron::mutable_input_indices() {
  // @@protoc_insertion_point(field_mutable_list:sparse_net_library.Neuron.input_indices)
  return &input_indices_;
}
inline const ::sparse_net_library::Synapse_interval& Neuron::input_indices(int index) const {
  // @@protoc_insertion_point(field_get:sparse_net_library.Neuron.input_indices)
  return input_indices_.Get(index);
}
inline ::sparse_net_library::Synapse_interval* Neuron::add_input_indices() {
  // @@protoc_insertion_point(field_add:sparse_net_library.Neuron.input_indices)
  return input_indices_.Add();
}
inline const ::PROTOBUF_NAMESPACE_ID::RepeatedPtrField< ::sparse_net_library::Synapse_interval >&
Neuron::input_indices() const {
  // @@protoc_insertion_point(field_list:sparse_net_library.Neuron.input_indices)
  return input_indices_;
}
