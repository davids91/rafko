...
extern PROTOBUF_INTERNAL_EXPORT_sparse_5fnet_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Neuron_sparse_5fnet_2eproto;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_Neuron_sparse_5fnet_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_Neuron_sparse_5fnet_2eproto}, {
...
static constexpr ::PROTOBUF_NAMESPACE_ID::EnumDescriptor const** file_level_enum_descriptors_sparse_5fnet_2eproto = nullptr;
...
const ::PROTOBUF_NAMESPACE_ID::uint32 TableStruct_sparse_5fnet_2eproto::offsets[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) = {
  ...
  PROTOBUF_FIELD_OFFSET(::sparse_net_library::Neuron, input_weights_),
  PROTOBUF_FIELD_OFFSET(::sparse_net_library::Neuron, input_indices_),
  ~0u,  // no _has_bits_
...
const char descriptor_table_protodef_sparse_5fnet_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  "\n\020sparse_net.proto\022\022sparse_net_library\032\014"
  "common.proto\"\365\001\n\006Neuron\022\020\n\010bias_idx\030\001 \001("
  "\r\022\030\n\020memory_ratio_idx\030\002 \001(\r\022E\n\025transfer_"
  "function_idx\030\003 \001(\0162&.sparse_net_library."
  "transfer_functions\022;\n\rinput_weights\030\004 \003("
  "\0132$.sparse_net_library.Synapse_interval\022"
  ";\n\rinput_indices\030\005 \003(\0132$.sparse_net_libr"
  "ary.Synapse_interval\"\212\001\n\tSparseNet\022\027\n\017in"
  "put_data_size\030\001 \001(\r\022\034\n\024output_neuron_num"
  "ber\030\003 \001(\r\0220\n\014neuron_array\030\004 \003(\0132\032.sparse"
  "_net_library.Neuron\022\024\n\014weight_table\030\005 \003("
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_sparse_5fnet_2eproto = {
  &descriptor_table_sparse_5fnet_2eproto_initialized, descriptor_table_protodef_sparse_5fnet_2eproto, "sparse_net.proto", 454,
  &descriptor_table_sparse_5fnet_2eproto_once, descriptor_table_sparse_5fnet_2eproto_sccs, descriptor_table_sparse_5fnet_2eproto_deps, 2, 1,
...
void Neuron::clear_input_weights() {
  input_weights_.Clear();
}
void Neuron::clear_input_indices() {
...
Neuron::Neuron(::PROTOBUF_NAMESPACE_ID::Arena* arena)
  ...
  input_weights_(arena),
  input_indices_(arena) {
  SharedCtor();
...
Neuron::Neuron(const Neuron& from)
  : ::PROTOBUF_NAMESPACE_ID::Message(),
      ...
      input_weights_(from.input_weights_),
      input_indices_(from.input_indices_) {
    ...
    switch (tag >> 3) {
      ...
      case 4:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 34)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(add_input_weights(), ptr);
            CHK_(ptr);
      ...
      case 5:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 42)) {
          ...
          do {
            ptr += 1;
            ptr = ctx->ParseMessage(add_input_indices(), ptr);
            CHK_(ptr);
            if (!ctx->DataAvailable(ptr)) break;
...
::PROTOBUF_NAMESPACE_ID::uint8* Neuron::InternalSerializeWithCachedSizesToArray(
  ...
  // repeated .sparse_net_library.Synapse_interval input_weights = 4;
  for (auto it = this->input_weights_.pointer_begin(),
            end = this->input_weights_.pointer_end(); it < end; ++it) {
    stream->EnsureSpace(&target);
  ...
  // repeated .sparse_net_library.Synapse_interval input_indices = 5;
  for (auto it = this->input_indices_.pointer_begin(),
            end = this->input_indices_.pointer_end(); it < end; ++it) {
    stream->EnsureSpace(&target);
    target = ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::
...
// @@protoc_insertion_point(message_byte_size_start:sparse_net_library.Neuron)
  ...
  // repeated .sparse_net_library.Synapse_interval input_weights = 4;
  total_size += 1UL * this->input_weights_size();
  for (const auto& msg : this->input_weights_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }

  // repeated .sparse_net_library.Synapse_interval input_indices = 5;
  total_size += 1UL * this->input_indices_size();
  for (const auto& msg : this->input_indices_) {
    total_size +=
      ::PROTOBUF_NAMESPACE_ID::internal::WireFormatLite::MessageSize(msg);
  }
...
// @@protoc_insertion_point(class_specific_merge_from_start:sparse_net_library.Neuron)
  ...
  input_weights_.MergeFrom(from.input_weights_);
  input_indices_.MergeFrom(from.input_indices_);
  if (from.bias_idx() != 0) {
...
void Neuron::InternalSwap(Neuron* other) {
  ...
  input_weights_.InternalSwap(&other->input_weights_);
  input_indices_.InternalSwap(&other->input_indices_);
