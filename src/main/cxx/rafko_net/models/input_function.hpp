...
public:
   ...
   */
  static Input_functions next(std::set<Input_functions> range = {
                                  input_function_add});
  ...
  /**
   * @brief      Calculate the derivative value of the given input function and
   * the given inputs
   *
   * @param[in]  function   The function to apply
   * @param[in]  a          A value to merge through the input function
   ...
   */
  static double get_derivative(Input_functions function, double a, double a_dw,
                               double b, double b_dw);

#if (RAFKO_USES_OPENCL)
  /**
   * @brief     Generates GPU kernel function code for the provided parameters
   *
   * @param[in]   function    The Input function to base the generated kernel
   * code on
   * @param[in]   a           A value to be merged through the input function
   * @param[in]   b           Another value to be merged through the input
   * function
   *
   * @return    The generated Kernel code merging the parameters through the
   * given input function
   */
  static std::string get_kernel_function_for(Input_functions function,
   ...
   * @get_kernel_enums
   * @param[in]   a                 A value to be merged through the input
  ...
  /**
   * @brief      Provide the kernel code for derivative of the given input
   * function and the given inputs
   *
   * @param[in]  function   The function to apply
   * @param[in]  a          A value to merge through the input function
   * @param[in]  a_w        The derivative value of @a
   ...
   * @param[in]  b_w        The derivative value of @b
   *
   * @return     The single operation representing the derivative of the input
   * function step
   */
  static std::string derivative_kernel_for(Input_functions function,
                                           std::string a, std::string a_dw,
                                           std::string b, std::string b_dw);
  ...
  static std::string get_kernel_enum_for(Input_functions function) {
    switch (function) {
    case input_function_add:
      return "input_function_add";
    case input_function_multiply:
      return "input_function_multiply";
    default:
      throw std::runtime_error(
          "Unidentified input function queried for information!");
    }
  }
