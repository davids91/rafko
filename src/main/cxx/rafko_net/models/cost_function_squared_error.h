...
public:
  Cost_function_squared_error(uint32 feature_size_, Service_context& service_context)
  : Cost_function(feature_size_, COST_FUNCTION_SQUARED_ERROR, service_context)
  { };
