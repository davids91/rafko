 ...
 * */
std::unique_ptr<rafko_net::Solution> test_solution_builder_manually(google::protobuf::Arena* arena, sdouble32 device_max_megabytes, std::vector<uint32> net_structure, uint32 recursion){
