...
/**
 * @brief      A phase of the Deep learning GPU pipeline strategy describing the
 * strategy of one entity for handling GPU operations
 */
...
public:
  ...
  /**
   * @brief     provides feedback on whether or not the current returned
   * interfaces would produce a valid GPU Kernel
   */
  bool isValid() const;
   ...
   *
   * @return     Vector of {name,source code} pairs in order of intended
   * execution
   */
  virtual std::vector<std::string> get_step_names() const = 0;

  /**
   * @brief      Provides the kernel source codes of the StrategyPhase in order
   * of execution
   *
   * @return     Vector of {name,source code} pairs in order of intended
   * execution
  ...
  /**
   * @brief      Provides the input dimensions of each step in the Strategy
   * Phase
   *
  ...
  /**
   * @brief      Provides the output dimensions of each step in the Strategy
   * Phase
   *
   * @return     Vector of dimensions in order of @get_steps
   */
  ...
  /**
   * @brief     Provides the overall size of every component of the output
   * buffer
   *
